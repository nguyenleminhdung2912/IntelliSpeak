...
public class InterviewSessionController {
    ...
    @PostMapping("/{interviewSessionId}/random-questions-by-session")
    @Operation(summary = "Get random questions by interviewSessionId with 5:3:2 ratio")
    public ResponseEntity<Response<SessionWithQuestionsDTO>> getRandomQuestionsBySession(@PathVariable Long interviewSessionId) {
        try {
            SessionWithQuestionsDTO dto = interviewSessionService.getRandomQuestionsBySession(interviewSessionId);
